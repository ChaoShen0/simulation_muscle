...
{	
	try {
			...
			double maxIsometricForce1 = 10000.0, optimalFiberLength1 = 0.1, tendonSlackLength1 = 0.2, pennationAngle1 = 0.0,
				activation = 0.0001, deactivation = 1.0;
			double maxIsometricForce2 = 1000, optimalFiberLength2 = 0.05, tendonSlackLength2 = 0.02, pennationAngle2 = 0.0;
			double maxIsometricForce3 = 1000, optimalFiberLength3 = 0.2, tendonSlackLength3 = 0.2, pennationAngle3 = 0.0;
